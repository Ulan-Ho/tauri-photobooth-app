    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" width="400px" height="600px" version="1.1" 
            ...
            <defs>
                ...
                {/* Add other clipPaths here if needed */}
            </defs>
            ...
            <g id="Слой_x0020_1">
                ...
                <image transform="matrix(0.684197 -0.193013 -0.193013 -0.684197 78.5329 1517.83)" x="0" y="0" width="93.47" height="89.62" href={lev} />
                <image transform="matrix(-0.684197 -0.193013 0.193013 -0.684197 1158.32 1517.83)" x="0" y="0" width="93.47" height="89.62" href={pre} />
            </g>
        </svg>
    );
}
